...
async function getCurrentIPv6() {
  ...
  const globalIPv6Services = [
    ...
    { url: 'https://v6.ident.me', timeout: 5000, name: 'ident.me' },
    { url: 'https://ipv6.tools.ietf.org/plain', timeout: 5000, name: 'ietf.org' },
    {
      url: 'https://api.ipbase.com/v1/json/', timeout: 5000, name: 'ipbase.com', parser: (data) => {
        try {
    ...
    { url: 'https://ip6only.me/api/', timeout: 5000, name: 'ip6only.me' },
    { url: 'https://ipv6.lookup.test-ipv6.com/ip/', timeout: 5000, name: 'test-ipv6.com' }
  ];
